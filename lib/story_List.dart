...
class StoryList {
  ...
  void nextStory(int choiceNum) {
    if (choiceNum == 1 && storyNum == 0) {
      storyNum = 2;
    } else if (choiceNum == 2 && storyNum == 0) {
      storyNum = 1;
    } else if (choiceNum == 1 && storyNum == 1) {
      storyNum = 2;
    } else if (choiceNum == 2 && storyNum == 1) {
      storyNum = 3;
    } else if (choiceNum == 1 && storyNum == 2) {
      storyNum = 5;
    } else if (choiceNum == 2 && storyNum == 2) {
      storyNum = 4;
